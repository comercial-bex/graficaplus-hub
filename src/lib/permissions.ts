...
export const permissions = [
  ...
  "margem.read",
  "impressao3d.read",
  "impressao3d.quote.create",
  "impressao3d.quote.update",
  "impressao3d.quote.approve",
  "impressao3d.cost.read",
  "impressao3d.cost.manage",
  "impressao3d.production.update",
  "impressao3d.close",
  "impressao3d.settings.manage",
  "impressao3d.reports.read",
  "os.read",
  "os.create",
  "os.update",
  "os.assign",
...
export function hasPermission(roles: AppRole[], permission: Permission) {
  return roles.some((role) =>
    (rolePermissions[role] as readonly Permission[] | undefined)?.includes(permission),
  );
}
...
export function getRoutePermission(pathname: string) {
  ...
  return (
    routePermissions.find(({ path }) => normalized === path || normalized.startsWith(`${path}/`))
      ?.permission ?? null
  );
}
