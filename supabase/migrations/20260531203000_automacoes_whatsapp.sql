...
VALUES
  ...
  ('WhatsApp interno: margem abaixo do mínimo', 'margem_abaixo_minimo', '{"margem_minima":30}'::jsonb, 'whatsapp', '{"mensagem":"Alerta: OS #{{os.numero}} está com margem real de {{os.margem_real}}%, abaixo do mínimo configurado.", "telefone":"{{admin_telefone}}"}'::jsonb, true, 0, 86400),
